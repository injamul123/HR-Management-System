...
if (isset($_POST['submit'])) {
    ...
    if (strlen($_POST['pf-perc']) < 1) {
        ...
        $sql = "UPDATE pf
            SET pf_perc = '$pf_perc', max_val = '$max_val'  WHERE id = '$id'";
           
        if ($db->query($sql) === true) {
            $msg = "PF updated successfully";
        } else {
            $error = "Failed to update pf, Please check your details and try again";
        }
    }
}
...
<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
    <a href="#"><strong><span class="fa fa-dashboard"></span> Edit PF</strong></a>
    <hr>
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                        <input type="hidden" name="id" value="<?php echo $id ?>">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="pf-perc" class="form-control"  aria-describedby="emailHelp" value="<?php echo $pf->pf_perc ?>">
                        </div>
                         <div class="form-group">
                            <label for="exampleInputEmail1" style="color:black">Max Value</label>
                            <input type="text" name="max-val" class="form-control"  aria-describedby="emailHelp" value="<?php echo $pf->max_val ?>">
                        </div>  
